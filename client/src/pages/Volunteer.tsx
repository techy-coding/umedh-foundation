      ...
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-slate-100">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold font-display text-slate-900 mb-2">Join Our Team</h1>
            <p className="text-slate-600">Volunteer your time and skills to help us create a better world.</p>
          </div>
